#!/usr/bin/env python
# coding: utf8
#	exec(open("Aufrufe/TermeGleichungen/erzeugeEinfachGleichungMitKlammerMitQuadrat.py").read())
...
#Setze Variablen:
    ...
    dateiName='gleichungenMitKlammerMitQuadrat'
...
#Erzeuge Aufgaben:
    ...
    lsg=[]
    for i in range(4):
        a,l,d=erzeugeEinfacheGleichung(variabel=random.choice(["a","b","x","y"]),mitKlammer=True)
