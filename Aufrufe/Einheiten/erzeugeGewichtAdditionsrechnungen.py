#!/usr/bin/env python
# coding: utf8
#	exec(open("Aufrufe/Einheiten/erzeugeGewichtAdditionsrechnungen.py").read())

exec(open("Funktionen/funktionen.py").read())
def main():
#Setze Variablen:
    title='Addiere und Subtrahiere die Gewichtseinheiten'
    lsgText='Loesungen '+title
    dateiName='GewichtEinheitenAdditionSubtraktion'
#    datum='31.05.2021'    #Wird kein Datum angeben, wird das morgige Datum genommen.
    anfang='Berechne die resultierende Einheit.'
    art='gewicht'
    einheiten=['t','kg','g','mg']
#Wähle die Einheiten so, dass diese maximal 1 Größenordnungen auseinander liegen.
    maxGroessOrd=1
    einheitenPaar=[]
