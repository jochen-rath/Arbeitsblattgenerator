...
#      'kuerzMit','reihe','reihePosZufaellig'
    rechnungsFunktionen={'ggT':'erzeugeGgt()','kgV':'erzeugeKgv()',
        ...
        'dreieckPrisErstMessen':F'erzeugePrismaErstmessenDannBerechnenAufgabe(anzSpalten={anzSpalten},typ="Dreieck",mitText={mitText})',
