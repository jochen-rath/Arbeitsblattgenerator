...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Zusammengesetzte Flächen':[('ZusGesetztFlaeche','Zusammengesetzte Rechteck Flächen bestimmen'),('ZusGesetztFlaecheSchw','Zusammengesetzte Rechteck Flächen bestimmen Schwer'),('pfeilFlaechenBer','Fläche vom Pfeil berechnen')],
