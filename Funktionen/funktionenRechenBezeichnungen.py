...
#      'kuerzMit','reihe','reihePosZufaellig'
    rechnungsFunktionen={'ggT':'erzeugeGgt()','kgV':'erzeugeKgv()',
        ...
        'einfacheZinsesZinsrechnung':F'einfachZinseszinsen(anzSpalten={anzSpaltenAfg})',
...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Textaufgaben':[('textAfgProzent','Prozentwertaufgaben'),('textAfgUmfProzent','Prozentwertaufgaben Formel umformen'),('textAfgUmfProzentVerm','Vermin/Vermehr Grundwertaufgaben'),('textAfgUmfProzentVermDreisatz','Vermin/Vermehr Grundwertaufgaben mit Dreisatz')]
    }
    if gebeListeZurueck:
