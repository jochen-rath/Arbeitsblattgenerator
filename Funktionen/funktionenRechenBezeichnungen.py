...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Prismen':[('QuaderVolOber','Vol., Oberfl. Quader'),('ZylinderVolOber','Vol., Oberfl. Zylinder'),('QuaderMitLoch','Vol., Oberfl. Quader Mit Loch'),('Dreiecksprisma','Dreiecksprisma'),('DreiecksprismaMessen','Dreiecksprisma Seiten messen'),('quaderFehlSeiteBerechnen','Quader, fehlende Seite berechnen')],
