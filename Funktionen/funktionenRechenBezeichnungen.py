...
def MoeglicheRechnungen(auswahl='keys'):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Prozent- und Zinsrechnung':[('schraffiereRechteckProzentVorgabe','Zeichen Rechteck Vorg.'),('schraffiereRechteckProzent','Zeichne Rechteck'),('schraffiertenProzentErkennen','Erkennen den Prozentwert'),('schraffiertenProzentErkennenKreis','Erkennen den Prozentwert im Kreis'),('ProzRechPWert','Prozentwert berechnen'),('ProzRechPsatzWert','Prozentsatz berechnen'),('ProzRechGWert','Grundwert berechnen'),('ZinsenBerechnen','Zinsen berechnen'),('ZinsatzBerechnen','Zinsatz berechnen'),('KapitalBerechnen','Kapital berechnen'),('verminderterGrundwert','verminderten G-Wert berechnen'),('vermehrterGrundwert',' vermehrten G-Wert berechnen'),('verminderterGrundwertMitQ','vermin. G-Wert mit q berechnen'),('verminderterGrundwertMitQ','vermehr. G-Wert mit q berechnen'),('TagesMonatsZinsen','Tages- Monatszinsen berechnen')],
