...
#Proportionalitaeten und Prozente
        ...
        'ZinsenBerechnen':'zinsrechnungen(einfach=True,ges="Z")',
        'ZinsatzBerechnen':'zinsrechnungen(einfach=True,ges="p")',
        'KapitalBerechnen':'zinsrechnungen(einfach=True,ges="K")',
        'gemischKapitalBerechnen':'zinsrechnungen()',
        'gemischKapitalBerechnenEinf':'zinsrechnungen(einfach=True)',
...
#Prismen
        ...
        'quaderFehlSeiteBerechnenBeiV':F'erzeugeQuaderFehlSeiteBerech(anzSpalten={anzSpaltenAfg},VO=["V"],mitText={mitText})',
        'quaderFehlSeiteBerechnenBeiO':F'erzeugeQuaderFehlSeiteBerech(anzSpalten={anzSpaltenAfg},VO=["O"],mitText={mitText})',
        'prismaFehlSeiteBerechnenNurVhK':F'erzeugePrismaFehlendeSeiteBerechnen(anzSpalten={anzSpaltenGesamt},nurVhK=True,mitText={mitText})',
        'prismaFehlSeiteBerechnenNurOGM':F'erzeugePrismaFehlendeSeiteBerechnen(anzSpalten={anzSpaltenGesamt},nurOGM=True,mitText={mitText})',
        ...
        'prismaVOmitVorgmitFormeln':F'erzeugePrismaVolOMitVorgabe(typ="Dreieck",mitFormeln=True,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
        'prismaVOmitVorg':F'erzeugePrismaVolOMitVorgabe(typ="Dreieck",mitFormeln=False,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
        'prismaVOmitVorgStehend':F'erzeugePrismaVolOMitVorgabe(typ="Dreieck",mitFormeln=False,stehend=True,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
        'prismaVOTrapezMitVorgmitFormeln':F'erzeugePrismaVolOMitVorgabe(typ="Trapez",mitFormeln=True,stehend=False,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
        'prismaVOTrapezMitVorg':F'erzeugePrismaVolOMitVorgabe(typ="Trapez",mitFormeln=False,stehend=False,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
        'prismaVOTrapezMitVorgStehend':F'erzeugePrismaVolOMitVorgabe(typ="Trapez",mitFormeln=False,stehend=True,anzSpalten={anzSpaltenGesamt},mitText={mitText})',
#Zylinder, Kegel
        ...
        'PyramideVolOber':f'erzeugePyramideOberVolBerech(einheit="cm",quadratisch=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'PyramideVolOberHaBer':f'erzeugePyramideOberVolBerech(einheit="cm",haBerechnen=True,quadratisch=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'kugelVolOber':f'erzeugeKugelOberVolBerech(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
...
#Terme
        ...
        'bionomischeFormeln':F'einfachAnwendungBionomischeFormeln(mitText={mitText})',
...
#Quadratische Funktionen
        ...
        'quadrFktBCAuslesen':f'erzeugeQuadVariAuslesen(erkenneBC=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadrFktABCAuslesen':f'erzeugeQuadVariAuslesen(mitB=True,mitC=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadFktNullstlBerOhneB':f'erzeugeFindNullstellenQuaFkt(mitA=True,mitB=False,mitC=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadFktNullstlBerOhneA':f'erzeugeFindNullstellenQuaFkt(mitA=False,mitB=True,mitC=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadFktNullstlBer':f'erzeugeFindNullstellenQuaFkt(mitA=True,mitB=True,mitC=True,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadFktNullstlBerOhneANormal':f'erzeugeFindNullstellenQuaFkt(mitA=False,mitB=True,mitC=True,scheitelform=False,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'quadFktNullstlBerNormal':f'erzeugeFindNullstellenQuaFkt(mitA=True,mitB=True,mitC=True,scheitelform=False,mitText={mitText},anzSpalten={anzSpaltenGesamt})',
#Quadratwurzel
...
#Geometrie
        ...
        'MittelsenkrechteMitVorgabe':F'erzeugeMittelsenkrechteAufgabe(mitText={mitText},mitLinie=True)',
        'Mittelsenkrechte':F'erzeugeMittelsenkrechteAufgabe(mitText={mitText},mitLinie=False)',
        'dreieckUmkreis':f'erzeugeDreieckUmkreisAufgabe(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'Winkelhalbierende':F'erzeugeWinkelhalbbierendeAufgabe(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'dreieckInnenkreis':f'erzeugeDreieckInnenAufgabe(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
...
#Sinus/Kosinus
        'formuliereSin':F'erzeugeSinussatzRechtwBenennen(sinKosTan="Sinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'formuliereKos':F'erzeugeSinussatzRechtwBenennen(sinKosTan="Kosinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'formuliereTan':F'erzeugeSinussatzRechtwBenennen(sinKosTan="Tangens",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'formuliereSinKosTanGemischt':F'erzeugeSinussatzRechtwBenennen(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSeiteSin':F'erzeugeSinussatzSeitenRechtwBerechnen(sinKosTan="Sinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSeiteKos':F'erzeugeSinussatzSeitenRechtwBerechnen(sinKosTan="Kosinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSeiteTan':F'erzeugeSinussatzSeitenRechtwBerechnen(sinKosTan="Tangens",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSeiteSinKosTanGemischt':F'erzeugeSinussatzSeitenRechtwBerechnen(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSin':F'erzeugeSinussatzRechtwBerechnen(sinKosTan="Sinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneKos':F'erzeugeSinussatzRechtwBerechnen(sinKosTan="Kosinus",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneTan':F'erzeugeSinussatzRechtwBerechnen(sinKosTan="Tangens",mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'berechneSinKosTanGemischt':F'erzeugeSinussatzRechtwBerechnen(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
        'formuliereSinussatzBelDreieck':f'erzeugeSinussatzBelWinkelBenennen(mitText={mitText},anzSpalten={anzSpaltenGesamt})',
#Physik
...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben'),('grZahlenAdd','Kopf Große Zahlen Addieren'),('grZahlenSub','Kopf Große Zahlen Subtrahieren'),('grZahlenMul','Kopf Große Zahlen Multiplizieren'),('grZahlenDiv','Kopf Große Zahlen Dividieren')],
                     ...
                     'Quadratische Funktionen':[('quadrFktZeichVorg','Q Fkt zeichnen, alles vorg.'),('quadrFktZeichNichtsVorg','Q Fkt zeichnen, nichts vorg.'),('quadrFktZeichMitBVorg','Q Fkt mit B zeichnen, WerteTab vorg.'),('quadrFktZeichMitBNichtsVorg','Q Fkt mit B zeichnen, nichts vorg.'),('quadrFktZeichMitBCVorg','Q Fkt mit B,C zeichnen, WerteTab vorg.'),('quadrFktZeichMitBCNichtsVorg','Q Fkt mit B,C zeichnen, nichts vorg.'),('quadrFktAAuslesen','Erkenne a'),('quadrFktACAuslesen','Erkenne a,c'),('quadrFktABAuslesen','Erkenne a,b'),('quadrFktBCAuslesen','Erkenne b,c'),('quadrFktABCAuslesen','Erkenne a,b,c'),('quadFktNullstlBerOhneA','Nullstellen der Parabel ber. mit A=1'),('quadFktNullstlBerOhneB','Nullstellen der Parabel ber. ohne b'),('quadFktNullstlBer','Nullstellen der Parabel ber.'),('quadFktNullstlBerOhneANormal','Nullst. Normalform a=1'),('quadFktNullstlBerNormal','Nullst. Normalform')],
                     'Sinus, Kosinus, Tangens':[('formuliereSin','Formuliere den Sinus'),('formuliereKos','Formuliere den Kosinus'),('formuliereTan','Formuliere den Tangens'),('formuliereSinKosTanGemischt','Formuliere den Sin/Kos/Tan'),('berechneSeiteSin','Berechne Seiten mit Sinus'),('berechneSeiteKos','Berechne Seiten mit Kosinus'),('berechneSeiteTan','Berechne Seiten mit Tangens'),('berechneSeiteSinKosTanGemischt','Berechne Seiten mit Sin/Kos/Tan'),('berechneSin','Berechne den Sinus'),('berechneKos','Berechne den Kosinus'),('berechneTan','Berechne den Tangens'),('berechneSinKosTanGemischt','Berechne den Sin/Kos/Tan'),('formuliereSinussatzBelDreieck','Formuliere Sinussatz bel.Dreieck')],
