...
def MoeglicheRechnungen(auswahl='keys'):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Proportionalitäten und Zuordnungen':[('propAufgabeMitPfeilenBeschr','Prop Tabelle mit Beschr'),('propAufgabeMitPfeilen','Prop Tabelle mit Pfeilen'),('propAufgabe','Prop Tabelle'),('antiPropAufgabe','Antiprop. Tabelle'),('propDreisatzEinfach','Dreisatz Einfach'),('propZuordDreisatzEinfach','Dreisatz mit Text/Einfach'),('propZuordDreisatz','Dreisatz mit Text'),('propZuordDreisatzKomma','Dreisatz mit Text und Komma')],
