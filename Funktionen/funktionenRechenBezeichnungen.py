...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Terme und Gleichungen':[('zahlInTermEinsetzen','Werte Einsetzen'),('findeTerm','Bestimme Term bei vorg. x und Erg.'),('termeUmformenHS','Terme umformen HS'),('termeUmformen','Terme umformen'),('termeUmformenKlammer','Terme mit Klammern umformen'),('einfacheGleichung','einfache Gleichung lösen'),('einfacheGleichungOhneKomma','einfache Gleichung lösen Ohne Komma'),('einfacheGleichungMitKlammer','einf. Gleichung mit Klammer lösen'),('einfacheGleichungMitQuadrat','einf. Gl. mit Kl. und Quadrat lösen'),('einfacheFormelUmformen','Einfache Formeln umformen')],
