...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben'),('grZahlenAdd','Kopf Große Zahlen Addieren'),('grZahlenSub','Kopf Große Zahlen Subtrahieren'),('grZahlenMul','Kopf Große Zahlen Multiplizieren'),('grZahlenDiv','Kopf Große Zahlen Dividieren')],
                     ...
                     'Geometrie':[('winkelMessen','Winkel messen'),('winkelZeichnen','Winkel Zeichnen'),('findeParall','Bestimme die zwei Parallelen'),('findeSenkrecht','Finde die zwei Senkrechten'),('dreieckFehlWinkEinf','Dreieck fehl. Winkel ber. einf.'),('dreieckFehlWink5er','Dreieck fehl. Winkel ber. 5er.'),('strahlensatzFarbig','Strahlensatz Farbig'),('Mittelsenkrechte','Mittelsenkrechte'),('Winkelhalbierende','Winkelhalbierende'),('DreieckWSWMitPlan','Dreieck WSW Konstr. mit Plan'),('DreieckWSW','Dreieck WSW Konstr.'),('DreieckSWSMitPlan','Dreieck SWS Konstr. mit Planfigur'),('DreieckSWS','Dreieck SWS Konstr.'),('DreieckSSSMitPlan','Dreieck SSS Konstr. mit Planfigure'),('DreieckSSS','Dreieck SSS Konstr.')],
