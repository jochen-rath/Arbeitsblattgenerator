...
def MoeglicheRechnungen(auswahl='keys'):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Geometrie':[('strahlensatzFarbig','Strahlensatz Farbig'),('Mittelsenkrechte','Mittelsenkrechte'),('Winkelhalbierende','Winkelhalbierende'),('DreieckSSS','Dreieck SSS Konstr.'),('DreieckSWS','Dreieck SWS Konstr.')],
