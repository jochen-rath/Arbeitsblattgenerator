...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben'),('grZahlenAdd','Kopf Große Zahlen Addieren'),('grZahlenSub','Kopf Große Zahlen Subtrahieren'),('grZahlenMul','Kopf Große Zahlen Multiplizieren'),('grZahlenDiv','Kopf Große Zahlen Dividieren')],
                     ...
                     'Textaufgaben':[('textAfgSchrAddi','Schriftl. Addition'),('textAfgSchrSubtr','Schriftl. Subtraktion'),('textAfgSchrMulti','Schriftl. Multipl.'),('textAfgSchrDivi','Schriftl. Division'),('textAfgProzent','Prozentwertaufgaben'),('textAfgUmfProzent','Prozentwertaufgaben Formel umformen'),('textAfgUmfProzentVerm','Vermin/Vermehr Grundwertaufgaben'),('textAfgUmfProzentVermDreisatz','Vermin/Vermehr Grundwertaufgaben mit Dreisatz'),('textAfgZins','Zinserechnungen'),('textAfgUmfZins','Zinsrechnung mit Formel umformen'),('textAfgZinszins','Einfache Zinseszins Afg')],
