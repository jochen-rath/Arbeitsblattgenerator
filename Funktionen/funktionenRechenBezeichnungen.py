...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben'),('grZahlenAdd','Kopf Große Zahlen Addieren'),('grZahlenSub','Kopf Große Zahlen Subtrahieren'),('grZahlenMul','Kopf Große Zahlen Multiplizieren'),('grZahlenDiv','Kopf Große Zahlen Dividieren')],
                     ...
                     'Quadratische Funktionen':[('quadrFktZeichVorg','Q Fkt zeichnen, alles vorg.'),('quadrFktZeichNichtsVorg','Q Fkt zeichnen, nichts vorg.'),('quadrFktZeichMitBVorg','Q Fkt mit B zeichnen, WerteTab vorg.'),('quadrFktZeichMitBNichtsVorg','Q Fkt mit B zeichnen, nichts vorg.'),('quadrFktZeichMitBCVorg','Q Fkt mit B,C zeichnen, WerteTab vorg.'),('quadrFktZeichMitBCNichtsVorg','Q Fkt mit B,C zeichnen, nichts vorg.'),('quadrFktAAuslesen','Erkenne a'),('quadrFktACAuslesen','Erkenne a,c'),('quadrFktABAuslesen','Erkenne a,b'),('quadrFktBCAuslesen','Erkenne b,c'),('quadrFktABCAuslesen','Erkenne a,b,c'),('quadFktNullstlBerOhneB','Nullstellen der Parabel ber. ohne b'),('quadFktNullstlBer','Nullstellen der Parabel ber.')],
