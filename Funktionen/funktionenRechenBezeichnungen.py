...
#      'kuerzMit','reihe','reihePosZufaellig'
    rechnungsFunktionen={'ggT':'erzeugeGgt()','kgV':'erzeugeKgv()',
        ...
        'datenZurodnen':F'erzeugeSaeulenKreisDiagramm(typ="zuordnen",mitText={mitText})',
        'datenZeichnenEinfaerben':F'erzeugeSaeulenKreisDiagramm(typ="ZeichnenUndEinfaerben",mitText={mitText})',
        'datenZeichnen':F'erzeugeSaeulenKreisDiagramm(typ="Zeichnen",mitText={mitText})',
        'datenZeichnenUndBerechnen':F'erzeugeSaeulenKreisDiagramm(typ="ZeichnenUndBerechnen",mitText={mitText})',
        'datenAllesSelber':F'erzeugeSaeulenKreisDiagramm(typ="alles",mitText={mitText})',
...
def MoeglicheRechnungen(auswahl='keys',gebeListeZurueck=False):
    listeRechnungen={'Basisaufgaben':[('Basis','Plus, Minus, Mal, Geteil'),('Kopf','Kopfrechenaufgaben')],
                     ...
                     'Daten':[('datenZurodnen','Daten dem Säulen-/Kreisdiagramm zuord.'),('datenZeichnenEinfaerben','Daten zeichnen und Kreis Diag. einfärben.'),('datenZeichnen','Daten Säulen-/Kreisdiagr. Zeichnen'),('datenZeichnenUndBerechnen','Daten Zeichnen und Berechnen'),('datenAllesSelber','Daten alles auswerten')],
