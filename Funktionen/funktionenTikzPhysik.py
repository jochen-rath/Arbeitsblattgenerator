def hebelTikz(pos1=-6,m1=100,pos2=6,m2=100,breite='!'):
    ...
    tikzcommand.append(F"\\node at (\\gewichtPos,-1-\\gewichtLaenge/2) {{{m1} g}};")
    if pos2>0:
        tikzcommand.append(F"\\node[red] at (\\gewichtZweiPos,-1-\\gewichtLaenge/2) {{{m2} g}};")
    ...
    tikzcommand.append("\\draw (\\gewichtPos-\\gewichtLaenge/2,-1-\\gewichtLaenge) rectangle ++(\\gewichtLaenge,\\gewichtLaenge);")
    if pos2>0:  
        tikzcommand.append("\\draw[red] (\\gewichtZweiPos,0) -- (\\gewichtZweiPos,-1);")
        tikzcommand.append("\\draw[red] (\\gewichtZweiPos-\\gewichtLaenge/2,-1-\\gewichtLaenge) rectangle ++(\\gewichtLaenge,\\gewichtLaenge);")
